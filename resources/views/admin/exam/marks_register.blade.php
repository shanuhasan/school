            ...
            <div class="card">
                ...
                <form action="" method="get" id="searchForm">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.exam.marks_register') }}" class="btn btn-danger">Reset</a>
                    </div>
                </form>
            </div>
        </div>
...
@section('script')
    <script>
        $('.marksRegisterForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.exam.marks_register.store') }}",
                type: 'post',
                ...
                success: function(response) {
                    ...
                    if (response['status'] == true) {
                        // window.location.href = "{{ route('admin.exam.marks_register') }}";
                        location.reload();
                        $('.error').html('');
                    } else {
        ...
        $('.saveSingleData').click(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.exam.marks_register.single') }}",
                type: 'post',
                data: {
                    "_token": "{{ csrf_token() }}",
                    id: id,
